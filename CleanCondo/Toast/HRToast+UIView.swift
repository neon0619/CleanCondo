...
extension UIView {
    ...
    */
    ...
    func makeToastActivity(position pos: AnyObject, message msg: String = "") {
        ...
        activityView.backgroundColor = UIColor.clear().withAlphaComponent(HRToastActivityOpacity)
        ...
        objc_setAssociatedObject(self, &HRToastActivityView, activityView, objc_AssociationPolicy.OBJC_ASSOCIATION_COPY_NONATOMIC)
