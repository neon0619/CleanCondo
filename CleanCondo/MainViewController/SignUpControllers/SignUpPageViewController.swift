...
class SignUpPageViewController: UIPageViewController {
    ...
    private(set) lazy var orderedViewControllers: [UIViewController] = {
        ...
        return [self.newColoredViewController("Profile"),
                self.newColoredViewController("Unit"),
                self.newColoredViewController("Payment")]
    }()
    ...
    override func viewDidLoad() {
        ...
        signUpDelegate?.tutorialPageViewController(self,
    ...
    private func newColoredViewController(_ page: String) -> UIViewController {
